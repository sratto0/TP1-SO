...
void init_players_data_and_pipes(game_t *game, int players_fds[][2], int player_count,
                  int *max_fd);
void player_pos(game_t *game);
void create_players_processes(char **paths, int fds[][2], char *width, char *height, int player_count, game_t *game);
void close_not_needed_fds(int players_fds[][2], int player_count,
                          int current_player);
void safe_close(int fd);
void setup_fds_for_select(game_t *game, int players_fds[][2], int player_count, fd_set *active_fds);
...
void close_and_wait_players(game_t *game, int players_fds[][2], int player_count);
